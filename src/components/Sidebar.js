            ...
            <ul className="sidebar-menu">
              <li className="sidebar-menu__item">
                <NavLink to="/now_playing" activeClassName="is-active">
                  ...
                  >
                    ...
                    <path d="M10.576 3.368L15.122.74 14.79 0 9.066 1.897 7.953 4.473H0v1.983h1.148L2.708 18.6h7.875l1.56-12.144h1.147V4.473H10.1"></path>
                  </svg>
                  Now Playing
                </NavLink>
              </li>
              ...
              <li className="sidebar-menu__item">
                    ...
                    <g>
                      <g>
                        <g>
                          <path
                            fill="white"
                            d="M357.714,423.331c0,9.328-10.676,16.891-23.847,16.891H23.847C10.676,440.222,0,432.659,0,423.331V203.735
				c0-9.33,10.676-16.892,23.847-16.892h310.02c13.171,0,23.847,7.564,23.847,16.892V423.331L357.714,423.331z"
                          ...
                          <path
                            fill="white"
                            d="M491.858,447.677c0,0-1.986,14.904-15.899,14.904c-13.912,0-103.34-83.42-103.34-94.397V258.882
